...
export const registerAdmin = tryCatch(async(req, res)=> {
    ...
    await emailSender({
        ...
        html: `<h2> Welcome ${ lastName } ${ firstName }. Please verify your email with the link <a href="http://localhost:9000/api/admins">${token}</a></h2>`
    })
...
export const adminRetrievePass = tryCatch(async(req, res, next)=> {
